...
![Alt text](final%20output.png)

# Conclusion

As the accuracy of the model increases, the loss decreases. The final model has an accuracy of 92% and a loss of 0.18. The model is able to predict the class of the lesion with a high accuracy.
